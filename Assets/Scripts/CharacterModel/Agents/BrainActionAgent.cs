...
public class BrainActionAgent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        float areThereFreeStorageObjects = 0f;
        if (_memory.FindFreeOwnedStorageObject() != null) { areThereFreeStorageObjects = 1f; }
        ...
        sensor.AddObservation(areThereFreeStorageObjects);
    }
